...
1. `77-stage-ready-single-project-progress-v1.3.md` — **latest checkpoint: single-project Stage→Controlled Pilot, Gomoh preparing, same-project pilot canary, synthetic inventory**
2. `76-single-project-stage-controlled-pilot-strategy-v1.3.md` — approved zero-cost Stage→Gomoh+Dhanbad controlled-pilot strategy
3. `75-production-canary-recovery-inventory-readiness-v1.3.md` — guarded canary + recovery-inventory baseline
4. `74-production-like-load-operator-guard-readiness-v1.3.md` — guarded manual load workflow + backup/operator guard proof
